...
public class BoardMain {
	...
	public BoardMain() {
		dao = new BoardDao();
		board01 = new BoardVO(900022, "제목_900001", "내용_900001", 0, "", "pcwk", "", "pcwk");
	...
	public boolean isSameVO(BoardVO orgVO, BoardVO vsVO) {
		...
		if (orgVO.getSeq() == vsVO.getSeq() && orgVO.getTitle().equals(vsVO.getTitle())
				&& orgVO.getContents().equals(vsVO.getContents()) && orgVO.getReadCnt() == vsVO.getReadCnt()
				&& orgVO.getRegId().equals(vsVO.getRegId()) && orgVO.getModId().equals(vsVO.getModId())) {
			isSame = true;
		}
